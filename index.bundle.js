...
const appColor = _alt1_base__WEBPACK_IMPORTED_MODULE_0__.mixColor(255, 255, 255);
// Set Chat reader
let chatReader = new _alt1_chatbox__WEBPACK_IMPORTED_MODULE_1__["default"]();
chatReader.readargs = {
    colors: [
        _alt1_base__WEBPACK_IMPORTED_MODULE_0__.mixColor(255, 255, 255), //white
    ]
};
...
let findChat = setInterval(function () {
    if (chatReader.pos === null)
        ...
        chatReader.pos.boxes.map((box, i) => {
            jquery__WEBPACK_IMPORTED_MODULE_2__(".chat").append(`<option value=${i}>Chat ${i}</option>`);
        });
        if (localStorage.quiverChat) {
            jquery__WEBPACK_IMPORTED_MODULE_2__(".chat").val(localStorage.quiverChat);
    ...
    if (chat.indexOf("Your quiver will now use the following:") > -1) {
        ...
        for (const [key] of Object.entries(bolttype)) {
            if (getItem.item == bolttype[key]) {
                document.getElementById(`HTMLBoltImage`).src = `./Images/${bolttype[key]}.PNG`;
            }
        }
    }
}
jquery__WEBPACK_IMPORTED_MODULE_2__(document).ready(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2__(".chat").change(function () {
        ...
        showSelectedChat(chatReader.pos);
        localStorage.setItem("quiverchat", jquery__WEBPACK_IMPORTED_MODULE_2__(this).val());
    });
});
if (window.alt1) {
